...
function getWinInfo()
{
    ...
    xmlhttp.onreadystatechange = function()
    {
        ...
        card = back - 51;
        $(".back img").attr('src', "../img/" + back + ".png");
        $(".flop_card").attr('src', "../img/" + card + ".png");
    }
    xmlhttp.open("GET", "/try/ajax/ajax_info.txt", true);
    xmlhttp.send();
}
