...
<body>
	...
	<div id="prize">
		<img src="../images/prize.png" width="100%" /> <img
			...
			onclick='alert("我的中奖信息")' src="../images/my_prize_info.png"
	...
	<div id="div_login_all" style="display:none;">
		<div id="div_login_layer"></div>
		<div id="div_login_bg">
			<div id="div_login">
				<img id="img_login" src="../images/bg_login.png"> </img>
				<input  id="username" type="text" class="login_input" style="margin-top: 30%;" placeholder="请输入您的华为工号" /> 
				<input id="password" type="password" class="login_input" style="margin-top: 48%;" placeholder="请输入您的密码" />
				<img id="login_submit" src="../images/login_submit.png" style="" />
			</div>
		</div>
	</div>
	<script type="text/javascript" src="../js/weixin/fuka.js"></script>
